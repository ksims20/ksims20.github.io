  ...
  return (
    <VerticalTimeline>
      ...
      >
        ...
        <p style={{ color: 'black'  }}>During the preadolescent period of my life, I would often fiddle with any piece of technology I could find, for example, I would look through all the 
      ...
      >
        ...
        <p style={{ color: 'black'  }}> During this time I took CSCI 201 - Intro to OOP, it was taught in Eclipse, Java to be specific. As that title states, I learned
